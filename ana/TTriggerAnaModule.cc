...
using nigrelli::HistBase_t;
using nigrelli::TrackPar_t;
//------------------------------------------------------------------------------
#include "nigrelli/ana/TTriggerAnaModule.hh"

ClassImp(nigrelli::TTriggerAnaModule)
...
//-----------------------------------------------------------------------------
void TTriggerAnaModule::BookEventHistograms(nigrelli::HistBase_t* Hist, const char* Folder) {
  //  char name [200];
  //  char title[200];
